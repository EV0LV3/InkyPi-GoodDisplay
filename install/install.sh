...
fetch_waveshare_driver() {
  ...
  DRIVER_URL="https://raw.githubusercontent.com/EV0LV3/InkyPi-GoodDisplay/refs/heads/main/RaspberryPi_JetsonNano/python/lib/waveshare_epd/$WS_TYPE.py"
  ...
  if [ -f "$DRIVER_FILE" ]; then
    ...
    echo_error "https://github.com/EV0LV3/InkyPi-GoodDisplay/tree/main/RaspberryPi_JetsonNano/python/lib/waveshare_epd"
    exit 1
  fi

  EPD_CONFIG_FILE="$DRIVER_DEST/epdconfig.py"
  EPD_CONFIG_URL="https://raw.githubusercontent.com/EV0LV3/InkyPi-GoodDisplay/refs/heads/main/RaspberryPi_JetsonNano/python/lib/waveshare_epd/epdconfig.py"
